...
namespace plethocoreProject.persistence.Migrations
{
    ...
    [Migration("20200423072200_initial migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("plethocoreProject.entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("plethocoreProject.entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("plethocoreProject.entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("plethocoreProject.entity.PaymentRecord", b =>
                {
                    b.HasOne("plethocoreProject.entity.Employee", "Employee")
                        .WithMany("paymentRecord")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("plethocoreProject.entity.TaxYear", "TaxYear")
                        .WithMany()
